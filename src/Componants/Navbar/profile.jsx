...
const Profile = () => {
    ...
    return (     
        ...
        <div className="dropdown dropdown-end flex flex-row border-2 shadow-lg p-2 rounded-lg" tabIndex={0}>
                <label  className="btn btn-ghost btn-circle avatar ring ring-red-500 mt-2">
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content mt-20 z-[1] p-2 border-2 shadow-xl bg-base-200 rounded-box w-56">
             ...
             <p className='w-24 text-center cursor-pointer'>{user.displayName}</p>
        </div>
